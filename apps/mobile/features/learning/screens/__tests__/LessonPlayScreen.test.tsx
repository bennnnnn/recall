...
import LessonPlay from "@/features/learning/screens/LessonPlayScreen";
...
jest.mock("@/features/learning/context/ProjectsContext", () => ({ useProjects: () => ({ refresh: mockRefresh }) }));
jest.mock("@/features/learning/hooks/useLearningDetail", () => ({
  useLearningDetail: () => ({
    project: mockProject,
    loading: false,
    loadError: false,
...
jest.mock("@/features/learning/model/projectDetailCache", () => ({
  updateLearningDetailCache: jest.fn(),
  fetchLearningDetail: jest.fn(),
}));
jest.mock("@/features/learning/hooks/useLessonFeedback", () => ({
  useLessonFeedback: () => ({
    speak: jest.fn(),
    celebrate: jest.fn(),
    stop: jest.fn(),
...
jest.mock("@/features/learning/hooks/useLessonPrefs", () => ({
  useLessonPrefs: () => ({
