...
import { syncTodoReminders, cancelAllTodoReminders, todoNotificationId } from "@/features/todos/model/todoReminders";
...
jest.mock("@/features/todos/model/reminderPrefs", () => ({ getReminderLeadMs: jest.fn(async () => 600_000) }));
