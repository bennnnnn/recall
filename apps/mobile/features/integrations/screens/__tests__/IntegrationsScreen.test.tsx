...
import ConnectedAppsScreen from "@/features/integrations/screens/IntegrationsScreen";
import type { useSettingsIntegrations } from "@/features/integrations/hooks/useSettingsIntegrations";
...
jest.mock("@/features/integrations/hooks/useSettingsIntegrations", () => ({ useSettingsIntegrations: () => mockIntegrations }));
