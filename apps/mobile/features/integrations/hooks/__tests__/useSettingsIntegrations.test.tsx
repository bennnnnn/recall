...
import { useSettingsIntegrations } from "@/features/integrations/hooks/useSettingsIntegrations";
import { api, type GoogleCalendarStatus, type GoogleGmailStatus } from "@/lib/api";
import { connectGoogleCalendar } from "@/features/integrations/model/googleCalendar";
import { connectGoogleGmail } from "@/features/integrations/model/googleGmail";
...
jest.mock("@/features/integrations/model/googleCalendar", () => ({ connectGoogleCalendar: jest.fn() }));
jest.mock("@/features/integrations/model/googleGmail", () => ({ connectGoogleGmail: jest.fn() }));
