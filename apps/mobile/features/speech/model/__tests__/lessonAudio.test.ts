import { createLessonAudio } from "@/features/speech/model/lessonAudio";
import { stopSpeaking } from "@/features/speech/model/pronunciation";
import { loadExpoAudio } from "@/lib/speech/voiceAudio";
import * as Speech from "expo-speech";
jest.mock("@/features/speech/model/pronunciation", () => ({ stopSpeaking: jest.fn() }));
