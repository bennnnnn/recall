...
import { computeCircleLabels, scaleToFit, type CircleSpec } from "@/lib/math/geometryBlock";
import i18n from "@/lib/i18n";
import { type Theme } from "@/lib/theme";

export function CircleDiagram({ spec, screenWidth, theme }: { spec: CircleSpec; screenWidth: number; theme: Theme }) {
