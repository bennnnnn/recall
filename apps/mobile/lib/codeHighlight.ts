/**
 * Syntax highlighting via Prism.js — see FEATURES.md §4.
 * Components are loaded with require() after assigning globalThis.Prism so Metro
 * registers grammars on the same instance we tokenize with.
 */
...
const LANG_TO_PRISM: Record<string, string> = {
