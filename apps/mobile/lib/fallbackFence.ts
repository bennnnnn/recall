 ...
 * them as a styled prose callout instead of code. Other structured fences
 * (chart/mermaid/math/…) stay as styled code blocks — their raw source is at
 * least visible, which is honest degradation.
 */
