...
async def test_generate_image_falls_back_to_second_model():
    settings = Settings(
        ...
        image_generation_enabled=True,
        image_generation_model="google/gemini-2.5-flash-image",
        image_generation_fallback_models="bytedance-seed/seedream-4.5",
    )
    import base64
    ...
    assert models == ["google/gemini-2.5-flash-image", "bytedance-seed/seedream-4.5"]


def test_image_model_candidates_dedupes_primary():
    settings = Settings(
        image_generation_model="google/gemini-2.5-flash-image",
        image_generation_fallback_models="google/gemini-2.5-flash-image,bytedance-seed/seedream-4.5",
    )
