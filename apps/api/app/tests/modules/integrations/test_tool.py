...
async def test_conflicts_uses_google_events_not_only_caller_supplied():
    ...
    from app.modules.integrations.tool import CalendarAdapter, bind_calendar_context
    ...
    with (
        ...
        patch(
            "app.modules.integrations.tool.calendar_service.fetch_upcoming_events",
            AsyncMock(return_value=[google_event]),
        ),
        patch(
            "app.modules.integrations.tool.SessionLocal",
