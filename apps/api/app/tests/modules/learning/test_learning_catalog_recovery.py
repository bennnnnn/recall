...
from app.modules.learning import path, path_seed
from app.modules.learning.crud import get_learning_detail
from app.tests.modules.learning.test_learning_catalog_reconciliation import _saved_item
from app.tests.modules.learning.test_learning_catalog_reconciliation import (
    catalog_sql as _catalog_sql,
)
from app.tests.modules.learning.test_learning_catalog_seed import _seed_environment
...
async def test_cache_failure_retries_invalidation_without_replacing_seeded_rows(
    ...
    monkeypatch.setattr("app.modules.learning.common._invalidate_home_for_user", invalidation)
    redis = await dispatch_seed(monkeypatch, user_id, project_id)
