...
from app.modules.learning.home_starters import completed_today, project_highlight
from app.modules.learning.insights import pick_learning_nudge
from app.modules.learning.practice_context import load_activity_context
from app.modules.learning.practice_history import merge_practice_history, merge_practice_items
from app.modules.learning.prompt_context import load_learning_classes_for_prompt
...
async def test_no_active_class_is_explicit_in_ordinary_chat_context():
    with patch("app.modules.learning.repository.list_for_user", AsyncMock(return_value=[])):
...
async def test_chat_uses_saved_partial_activity_for_skipped_days():
    ...
    with (
        patch(
            "app.modules.learning.practice_repository.list_events", AsyncMock(return_value=[saved])
        ),
        patch(
