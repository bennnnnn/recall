...
from app.modules.learning.schemas import LearningItemOut
...
def test_practice_route_returns_current_item_and_retry_disposition(route_client, recorded):
    ...
    attempt = uuid4()
    with patch(
        "app.modules.learning.practice.record_practice",
...
def test_invalid_practice_body_never_records(route_client, bad):
    ...
    with patch("app.modules.learning.practice.record_practice", AsyncMock()) as record:
        result = client.post(
