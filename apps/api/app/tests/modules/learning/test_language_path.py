...
from app.modules.learning.crud import group_items
from app.modules.learning.path import (
    append_chapter,
    build_path_progress,
    chapter_is_complete,
...
from app.modules.learning.prompt_context import format_learning_block
...
async def test_seed_language_path_copies_catalog_words():
    ...
    with (
        ...
        patch(
            "app.modules.learning.catalog_repository.lock_project", AsyncMock(return_value=project)
        ),
        patch("app.modules.learning.catalog_repository.list_items", AsyncMock(return_value=[])),
        patch("app.modules.learning.catalog_repository.insert_missing", created),
        patch("app.modules.learning.catalog_repository.update_contents", AsyncMock()),
        patch("app.modules.learning.path_seed.ensure_catalog_rows", ensure),
        patch("app.modules.learning.common._invalidate_home_for_user", AsyncMock()),
    ):
...
def test_needs_catalog_sync_when_path_is_old_llm_titles():
    ...
    from app.modules.learning.path_seed import needs_catalog_sync
...
def test_apply_full_catalog_path_puts_every_group_on_the_map():
    from app.modules.learning.path_seed import apply_full_catalog_path
...
async def test_get_learning_detail_enqueues_catalog_sync_without_blocking_get():
    ...
    from app.modules.learning.crud import get_learning_detail
    ...
    with (
        ...
        patch("app.modules.learning.practice_repository.list_events", AsyncMock(return_value=[])),
        patch("app.modules.learning.crud.enqueue_language_path_job", enqueue),
        patch("app.modules.learning.path_seed.seed_language_path", seed),
        patch("app.modules.learning.path_seed.needs_catalog_sync", return_value=True),
    ):
