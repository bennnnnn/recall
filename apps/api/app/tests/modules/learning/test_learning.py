...
from app.modules.learning import prompt_context as learning_prompt_context
from app.modules.learning import repository as learning_repo
from app.modules.learning import sync as learning_sync
...
def test_normalize_and_infer_target_language():
    ...
    from app.modules.learning.common import infer_target_language
...
async def test_apply_learning_actions_rolls_back_whole_batch_on_late_failure():
    ...
    with (
        ...
        patch(
            "app.modules.learning.common._invalidate_home_for_user",
            AsyncMock(),
        ) as invalidate,
    ):
...
async def test_sync_learning_from_transcript_does_not_add_language_words():
    ...
    from app.modules.learning import sync_learning_from_transcript
...
def test_stats_for_items_matches_repository_stats_for_due_for_review():
    ...
    from app.modules.learning.stats import stats_from_items
...
async def test_apply_learning_actions_start_learning_records_failed_quiz():
    ...
    with (
        ...
        patch(
            "app.modules.learning.quiz_grading.apply_quiz_result",
            AsyncMock(return_value=existing),
        ) as apply_result,
    ):
        applied = await learning_service.apply_learning_actions(
...
async def test_apply_learning_actions_master_not_skipped_as_fuzzy_duplicate():
    ...
    with (
        ...
        patch(
            "app.modules.learning.items.update_item",
...
async def test_sync_learning_from_transcript_applies_litellm_actions():
    ...
    with (
        ...
        patch(
            "app.modules.learning.extract.extract_learning_actions",
...
def test_language_tutor_hint_uses_target_language():
    from app.modules.learning import language_tutor_hint
...
def test_chat_learning_handoff_hint_forbids_in_chat_quiz():
    from app.modules.learning import CHAT_LEARNING_HANDOFF_HINT
...
def test_chat_tutor_hints_acknowledge_completed_daily_goal():
    ...
    from app.modules.learning import DAILY_GOAL_COMPLETE_BEHAVIOR, language_tutor_hint
