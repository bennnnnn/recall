...
from app.modules.learning import stats as stats_service
...
async def test_count_stats_aggregates_statuses(monkeypatch):
    ...
    monkeypatch.setattr(
        "app.modules.learning.stats.learning_items_repo.count_stats_sql",
        _count_stats_sql,
    )
...
async def test_count_stats_by_learning_groups_items_per_project(monkeypatch):
    ...
    monkeypatch.setattr(
        "app.modules.learning.stats.learning_items_repo.count_stats_by_learning_sql",
        _by_project_sql,
    )
