"""Tests for app.modules.learning.repository."""
...
async def test_projects_list_excludes_archived_by_default(fake_session):
    from app.modules.learning.repository import list_for_user
...
async def test_list_for_users_returns_empty_without_querying(fake_session):
    from app.modules.learning.repository import list_for_users
...
async def test_find_language_by_target(fake_session):
    from app.modules.learning.repository import find_language_by_target
...
async def test_projects_create_normalizes_vocabulary_kind(fake_session):
    from app.modules.learning.repository import create
...
async def test_projects_delete_by_id_not_found(fake_session):
    from app.modules.learning.repository import delete_by_id
