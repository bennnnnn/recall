...
from app.modules.learning import items_repository as items_repo
from app.modules.learning import practice_repository as practice_repo
from app.modules.learning.daily import (
    build_daily_history,
    parse_daily_goal_history,
    resolve_daily_goal,
)
from app.modules.learning.practice_history import merge_practice_history
