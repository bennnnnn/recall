...
from app.modules.learning.activity_repository import activity_columns, activity_values
from app.modules.learning.policy import start_of_today_utc
...
async def create(
    ...
    *,
    ...
    item = LearningItem(
        ...
        simple_gloss=(simple_gloss or "").strip() or None,
        chat_id=chat_id,
        status=status,
