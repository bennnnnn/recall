...
from app.modules.learning.common import (
    DEFAULT_LIST,
...
from app.modules.learning.prompts import (
    CHAT_LEARNING_HANDOFF_HINT,
    _language_tutor_hint,
    _quiz_mode_banner,
)
from app.modules.learning.schemas import PathChapterProgress
...
async def load_learning_for_prompt(
    ...
    *,
    ...
    if _is_language_project(project):
        from app.modules.learning.path_seed import apply_full_catalog_path, current_catalog_items
...
async def load_today_learning_words_for_prompt(
    ...
    *,
    ...
    from app.modules.learning.policy import day_bounds_utc
    from app.services import time_context as time_context_service
    ...
    for project in learning_projects:
        ...
        from app.modules.learning.path_seed import current_catalog_items
