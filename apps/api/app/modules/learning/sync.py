...
from app.modules.learning.actions import MAX_LEARNING_ACTIONS_PER_TURN
from app.modules.learning.common import _item_status
...
async def _apply_project_extraction_result(
    ...
    *,
    ...
    from app.modules.learning import apply_learning_actions
...
async def _run_extracted_project_actions(
    ...
    *,
    ...
    from app.modules.learning.extract import extract_learning_actions
