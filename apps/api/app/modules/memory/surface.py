...
``app.modules.memory.*`` monkeypatches continue to affect collaborators.
"""
...
from app.modules.memory import cache as _cache
from app.modules.memory import crud as _crud
from app.modules.memory import locks as _locks
from app.modules.memory import retrieval as _retrieval
from app.modules.memory.consolidation import (
...
from app.modules.memory.selection import (
...
from app.modules.memory.text import (
...
from app.modules.memory.text import (
    memory_extract_user_text as memory_extract_user_text,
)
from app.modules.memory.text import (
...
def _seams():
    # Callers patch the package (`app.modules.memory.*`), not this module.
    return sys.modules["app.modules.memory"]
