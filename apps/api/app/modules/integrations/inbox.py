...
async def _extract_reminder_item(
    ...
    *,
    ...
    if extracted is not None:
        return extracted
    from app.modules.integrations.sender_templates import extract_from_sender_template
...
async def _write_suggested_reminder(
    ...
    from app.modules.integrations.sender_templates import display_sender
...
async def add_suggested_reminder(
    ...
    todo = await create_external_todo(
        session,
        user,
