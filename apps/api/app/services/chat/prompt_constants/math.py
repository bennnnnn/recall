...
MATH_SOLVER_HINT = (
    ...
    "- Physics — verified: kinematics, projectile, force, energy, momentum, "
    "friction, circular, spring, circuit, torque. When a verified physics block "
    ...
    "exist only for kinematics (height or velocity against time), projectile "
    "(x-y path) and spring SHM (displacement against time); every other answer "
    "is a number — do not invent a plot. OUTSIDE that list (pressure, "
    "thermodynamics, gravitation, waves, optics, pendulum) nothing is checked: "
    "do NOT claim verification; be cautious and say when you are unsure."
)
