...
MATH_SOLVER_HINT = (
    ...
    "waves, optics, thermal. Use a verified physics block's exact numbers — never "
    ...
    "other answer is a number — do not invent a plot. OUTSIDE that list (pressure, "
    "gravitation, rotation, magnetism, materials) nothing is checked: do NOT claim "
    "verification; be cautious and say when you are unsure."
)
