...
MATH_SOLVER_HINT = (
    ...
    "modern. Use a verified physics block's exact numbers — never "
    ...
    "other answer is a number — do not invent a plot. OUTSIDE that list (relativity, "
    "quantum states, alternating current, entropy, interference) nothing is checked: do NOT claim "
    "verification; be cautious and say when you are unsure."
)
