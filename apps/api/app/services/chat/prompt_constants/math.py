...
MATH_SOLVER_HINT = (
    ...
    "- Physics — verified: kinematics, SUVAT (constant acceleration), "
    "projectile, force, energy, momentum, "
    "friction, circular, spring, pendulum, circuit, torque. When a verified physics block "
    ...
    "thermodynamics, gravitation, waves, optics) nothing is checked: "
