...
VISUALIZATION_HINTS = (
    ...
    "the backend computes the mole ratio. For molar mass, ask `molar mass of <formula>` and "
    "the backend computes it with RDKit. For molecular properties (LogP, TPSA, H-bond donors/"
    "acceptors), the backend computes RDKit descriptors when given a SMILES.\n\n"
