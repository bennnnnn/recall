...
def _can_direct_graph(verified: VerifiedMathBlock, user_text: str) -> bool:
    ...
    from app.services.math.match import graph_domain, prepare
    from app.services.math.match.graph import _GRAPH_PAIR_TRAILING_FILLER
    ...
    for prefix in ("graph ", "plot ", "draw ", "sketch ", "visualize ", "visualise "):
        ...
        return False
    from app.services.math.tools.extract import is_graph_followup
...
def _can_direct_number_line(verified: VerifiedMathBlock, user_text: str) -> bool:
    ...
    from app.services.math.match import prepare
    from app.services.math.solve.parse import _rewrite_bare_abs_bars
...
def can_direct_verified_math_reply(
    ...
    *,
    ...
    if not verified.allow_direct:
        return False
    from app.services.math.tools.direct_newton import can_direct_newton, has_newton_request
    ...
    if _underdetermined_triangle_measurement(verified, user_text) is not None:
        return True
    from app.services.math.tools.direct_geometry import (
    ...
    from app.services.math.match.coordinate_vector import (
    ...
    from app.services.math.tools.direct_units import unit_direct_request
