...
from app.services.math.match.scan import ddx_cue_at, ddx_expr_after, looks_like_math_expr
...
def _normalize_latex_expr(expr: str) -> str:
    """Delegate to math_solve so limit/series paths share frac/abs handling."""
    from app.services.math.solve import _normalize_latex_to_sympy
